...
2. right click on project folder and select open in terminal
![alt text](image.png)
...
6. type in terminal `npm i nodemon -D` to install nodemon ,
which restarts server while file changes. -D flag indicates install in dev dependency.
